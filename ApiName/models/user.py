...
class User(UserMixin, BaseModel):
    ...
    profile_picture = db.Column(
        db.String(255),
        default="http://res.cloudinary.com/dbn9ejpno/image/upload/v1700666059/iuqjx3u5ts4tpvofhdnn.png",
    )
    ...
    def __init__(
        ...
        otp_expiry=None,
        house_address=None,
        profile_picture="http://res.cloudinary.com/dbn9ejpno/image/upload/v1700666059/iuqjx3u5ts4tpvofhdnn.png",
        is_active=True,
        is_admin=False,
